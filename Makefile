...
tests: mjson.o waifuvault-c-api.o tests/waifuvault-c-test.c tests/waifuvault-c-buckets-test.c tests/waifuvault-c-restrictions-test.c tests/waifuvault-c-deserializer-test.c
	...
	gcc -O3 -w -o tests/waifuvault-c-deserializer-test tests/waifuvault-c-deserializer-test.c cJSON.o waifuvault-c-api.o -lcurl
